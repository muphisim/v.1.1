    ...
    def __init__(self):
        ...
        self.solvers = ({
                ...
                "DispBC":(
                            ...
                            ("DISPLACEMENT RAMP",(2,83), ((3,0.),)), 
                            ("DISPLACEMENT RAMP",(2,84), ((3,0.),)), 
                         ), 
                "Extraction":(
        ...
        self.NeumannBCs = {
                ...
                "Flux ExtraDof": (
                                    ...
                                    ("EXP VOLUMETRIC HEAT FLUX", "ALL", (0.,5e-5), (78288022.*0.1/(np.pi*0.1/np.sqrt(3.)),0.025,0.305,0.025,1e10,0.1/np.sqrt(3.),1e10)),
        ...
        self.materials = ({
                ...
                # extra dof field
                "ExtraDof": ("Temperature",(435e6, 0, 8.9, 0, 298., 298., 298.)),
                # support All or [(dim,phys), ...]
                "List of Elements": "All",
                },
                )
        self.initialBCs = {
                "INITIAL CONDITIONS EXTRADOF": (298.,)
                }
